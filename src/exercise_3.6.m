%% ===============================================================
% EXERCISE 3.6 — Effect of Misalignment (σ = 0, 10, 20 samples)
...
% Response-locked triplet (all corrections)
triplet_all = [1 8 1; 2 8 1; 3 1 8; 4 1 8];

sigmas = [0, 10, 20];   % perfect, misaligned 10, misaligned 20 samples
